...
import getProp from '../../../utils/styled/getProp'
...
const Path = styled.path`
  ...
  animation: ${getProp('animationName', writingAnimation)}
    ${getProp('animationDuration', '2.5s')} cubic-bezier(0.43, 0.02, 0.64, 0.99)
    ${getProp('delay', '2s')} forwards;
  stroke: #000;
...
const Logo = () => (
  <Box width={['200px', '275px', '300px', '300px', null, '375px']}>
    <Svg width="512.576" height="185" viewBox="0 0 512.576 185">
      <defs>
        <mask id="logo-mask">
          <g id="header_text_mask_first" transform="translate(145.114 71.417)">
            <Path
